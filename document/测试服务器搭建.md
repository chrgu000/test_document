...
####添加新端口##################################################
只添加一个单独的端口(示例为81)（--permanent永久生效，没有此参数重启后失效）
...
#######window脚本文件编译出错：syntax error: unexpected end of file
vim serverDeploy.sh
:set fileformat=unix
:wq
...
echo "#############启动语义服务和tomcat"
su appuser -c "/home/appuser/bin/start_all"
